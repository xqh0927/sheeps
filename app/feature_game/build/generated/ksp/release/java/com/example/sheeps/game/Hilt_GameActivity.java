...
public abstract class Hilt_GameActivity extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GameActivity_GeneratedInjector) this.generatedComponent()).injectGameActivity(UnsafeCasts.<GameActivity>unsafeCast(this));
    }
  }
