...
public abstract class Hilt_DuelActivity extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DuelActivity_GeneratedInjector) this.generatedComponent()).injectDuelActivity(UnsafeCasts.<DuelActivity>unsafeCast(this));
    }
  }
