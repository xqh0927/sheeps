...
public abstract class Hilt_MenuActivity extends BaseActivity implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MenuActivity_GeneratedInjector) this.generatedComponent()).injectMenuActivity(UnsafeCasts.<MenuActivity>unsafeCast(this));
    }
  }
