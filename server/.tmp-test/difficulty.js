...
exports.getBaseCardCount = getBaseCardCount;
exports.isRestLevel = isRestLevel;
exports.calculateCardCount = calculateCardCount;
 ...
 * @returns 难度信息
 */
function getDifficultyForLevel(userId, levelId) {
    ...
    if (levelId === 1) {
        ...
        while (levelCursor < levelId) {
            ...
            const rng = (0, level_1.lcg)(userId * 9973 + currentDifficulty * 10007);
 ...
 */
function getBaseCardCount(info, _levelId) {
 ...
 * @returns 卡牌数量计算结果
 */
function calculateCardCount(userId, levelId) {
