...
//#region src/dsl/openapi-builder32.ts
var s = class e {
	static create(t) {
		return new e(t);
	}
	...
	addPath(e, t) {
		return this.rootDoc.paths = this.rootDoc.paths || {}, this.rootDoc.paths[e] = {
	...
	addWebhook(e, t) {
		return this.rootDoc.webhooks ??= {}, this.rootDoc.webhooks[e] = t, this;
	}
};
//#endregion
//#region src/model/openapi32.ts
function c(t, n) {
	if (!e.isValidExtension(n)) return t ? t[n] : void 0;
}
function l(e) {
...
//# sourceMappingURL=oas32.mjs.map